// =====================================================
// PHC JACKPOT - APP.JS (COMPLETE VERSION)
// Global app functions and utilities
// =====================================================
...
// ==========================================================
// 2. SESSION GUARD - No login = no access
// ==========================================================
(function() {
    const currentPage = window.location.pathname.split('/').pop();
    const publicPages = ['login.html', 'register.html', 'admin-logs.html', 'admin-register.html'];
...
// ==========================================================
// 6. COUNTDOWN FUNCTION - Shared across all pages
// ==========================================================
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    console.log('✅ PHC App.js loaded successfully!');
    console.log('🔐 Session guard active');
    console.log('⏰ Countdown running');
    console.log('🏆 Winner tracker active');
});
